...
def test_topp_decoder_output_shape():
    """
    ...
    decoder = TopPSampler(model=model, sos_token=sos_token, eos_token=eos_token,
                          p=0.9, max_len=max_len)
...
def test_topp_decoder_stops_on_eos():
    """
